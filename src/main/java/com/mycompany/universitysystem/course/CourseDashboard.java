package com.mycompany.universitysystem.course;
...
public class CourseDashboard extends JFrame {
    ...
    private JPanel createSidebar() {
        ...
        logoIcon.setFont(new Font("Arial", Font.BOLD, 45));
        logoIcon.setForeground(GOLD);
        logoIcon.setAlignmentY(Component.TOP_ALIGNMENT);
    ...
    private void openCources() { new CourseDashboard().setVisible(true); }
    ...
    private JPanel createMainContent() {
        ...
        statsGrid.setBorder(BorderFactory.createEmptyBorder(40, 0, 0, 0));

        JPanel studentsCard = createStatCard("👤", "Python", String.valueOf(studentsCount));
        studentsValueLabel = getValueLabelFromCard(studentsCard);

        JPanel coursesCard = createStatCard("📚", "C++", String.valueOf(coursesCount));
        coursesValueLabel = getValueLabelFromCard(coursesCard);

        JPanel attendanceCard = createStatCard("✓", "Java", String.valueOf(attendanceCount));
        attendanceValueLabel = getValueLabelFromCard(attendanceCard);

        JPanel gradesCard = createStatCard("📋", "C", String.valueOf(gradesCount));
    ...
    private JPanel createStatCard(String icon, String label, String value) {
        ...
        card.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                JOptionPane.showMessageDialog(CourseDashboard.this,
                        "Details of " + label,
                        label,
